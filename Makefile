...
etapa5: parser.tab.o lex.yy.o main.o hash.o aux.o ast.o semantic.o tac.o
	gcc -g -o etapa5 parser.tab.o lex.yy.o main.o hash.o aux.o ast.o semantic.o tac.o
main.o: main.c
	gcc -g -c main.c
